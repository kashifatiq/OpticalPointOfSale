    ...
    <form id="form1" runat="server">
        <div id="loginDiv2" class="loginDiv">
            <table style="width: 100%;">
                ...
                <asp:Label ID="lblHeading" runat="server" Text="Login" ForeColor="#F44336" Font-Size="XX-Large"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: center;"><asp:Button ID="btnLogin" runat="server" Text="Save" CssClass="button buttonSubmit" OnClick="btnLogin_Click" /></td>
                </tr>
            </table>
        </div>
    </form>
